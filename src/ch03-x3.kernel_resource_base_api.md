...
- [clock](#clock)
  ...
  - [clk_perpare](#clk_perpare)
  - [clk_enable](#clk_enable)
  - [clk_perpare_enable](#clk_perpare_enable)
  - [clk_unperpare](#clk_unperpare)
  - [clk_disable_unperpare](#clk_disable_unperpare)
...
dev: 管理资源的设备，一般为总线匹配的设备
id: 需要获取的clocks内属性的别名，一般由clock-names定义，没有clock-names属性clocks内只有一个，此时对应NULL。
返回: 成功获取的时钟资源，可用于模块时钟管理(使能，关闭)，失败返回NULL

...
其中操作函数分为设置PWM值和读取当前背光设置等级，具体如下。
...
另外则都是操作PWM的代码，这部分可以参考PWM章节关于[pwm consumer使用接口](./ch03-12.pwm_frame.md#pwm_consumer)的内容说明，详细代码见[backlight驱动](./file/ch03-13/kernel_pwm_bl.c)说明。编译后加载驱动，查看backlight设备节点，如下所示。
...
详细的背光应用操作的代码见[backlight应用](./file/ch03-13/brightness_test.c)。

...
- 功能: 用于在系统中创建管理设备的文件(/sys/devices/platform/[dev]/[file])
- 目录：drivers/base/core.c
...
struct device_attribute {
    ...
    ssize_t (*show)(struct device *dev, struct device_attribute *attr,      //读取接口
            char *buf); 
    ssize_t (*store)(struct device *dev, struct device_attribute *attr,     //写入接口

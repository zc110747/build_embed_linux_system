...
- 功能: 根据节点的device_type和compatible属性查找设备节点。
- 目录: drivers/of/base.c
...
- 功能: 从匹配节点的id_table中获取reg属性对应寄存器

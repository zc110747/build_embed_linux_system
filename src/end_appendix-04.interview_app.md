...
- [Linux应用操作整理](#linux-app)
  ...
  - [内存碎片产生的原因，如何避免内存碎片](#interview-014)
  - [什么是守护进程，守护进程如何创建的](#interview-015)
  - [什么是僵尸进程和孤儿进程，讲述下产生原因，以及解决办法](#interview-016)
  - [进程的状态有哪些，切换的方式](#interview-018)
  - [系统中常用的命令有哪些，简述功能](#interview-019)
  - [系统中常用的进程创建方式有哪些](#interview-020)
  - [dd命令和FIO测试读写，有什么区别](#interview-021)

...
- 系统配置和管理
  - [alias](#alias)&emsp;
  - [cd](#cd)&emsp;[chmod](#chmod)&emsp;[chown](#chown)&emsp;[clear](#clear)&emsp;[cron](#cron)&emsp;[cut](#cut)&emsp;
  - [date](#date)&emsp;[depmod](#depmod)&emsp;[devmem2](#devmem2)&emsp;
  ...
  - [read](#read)&emsp;
  - [service](#service)&emsp;[source](#source)&emsp;[sudo](#sudo)&emsp;[systemctl](#systemctl)&emsp;

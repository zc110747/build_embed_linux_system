...
- [系统配置和管理](#system_config)
  ...
  - [history](#history)&emsp;[hostname](#hostname)&emsp;[htop](#htop)&emsp;[hwclock](#hwclock)&emsp;
...
ntpq是一个用于查询和控制 NTP（Network Time Protocol）服务器的命令行工具。NTP 是一种用于同步计算机时钟的协议，它允许计算机通过网络与其他 NTP 服务器进行时间同步。

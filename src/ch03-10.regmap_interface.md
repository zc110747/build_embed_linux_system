...
可以看到，对于接口中，最重要的结构就是用于初始化的`struct regmap_config`和保存信息的`struct regmap`属性。
...
详细的regmap icm20608驱动实现可见：[regmap icm20608驱动代码](./file/ch03-10/regmap_icm202608/kernel_regmap_spi.c)。

...
按键设备树的定义很简单，不过很多人不理解其中的经验，这里我正好说明下实现的方法。

1. 设备节点需要用platform总线匹配，只能放在root节点或者支持platform访问的特殊节点下
...
4. 作为input设备，需要中断触发，中断定义需要指定对应的中断控制器interrupt-parent，还有触发的中断线号和中断类型interrupts

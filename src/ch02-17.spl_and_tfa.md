...
U-Boot SPL是优化启动流程的一种方式，可以降低产品ROM代码异常的风险，因此目前应用也越来越广泛。理论上来说，U-Boot SPL和Trust Zone并没有直接关联，不过理解U-Boot SPL有助于去理解TrustZone执行流程，下面详细进行说明。

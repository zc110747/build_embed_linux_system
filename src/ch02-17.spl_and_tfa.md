...
- BootROM：由芯片厂商开发的，固化再芯片内部ROM的代码，主要实现不同的启动方法
- U-Boot：开源引导加载程序，提供启动相关处理的功能
- Linux Kernel：系统平台的核心组件，负责管理系统的硬件和软件资源
- System Rootfs：目录和文件的合集，提供命令操作环境
...
直接开始下一章节说明: [异构多核芯片工作处理](./ch02-18.heterogeneous_multi_core.md)

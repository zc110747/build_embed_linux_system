...
另外，本节中配套的iio器件驱动代码详见如下。

- [kernel iio-adc代码](./file/ch03-09/kernel_iio_adc.c)
- [kernel iio-hx711代码](./file/ch03-09/kernel_iio_hx711.c)
...
adc内部模块的驱动代码：[iio-adc驱动代码](./file/ch03-09/kernel_iio_adc.c)。
...
关于hx711模块的驱动代码实现完毕，详细驱动代码见: [hx711驱动代码](./file/ch03-09/kernel_iio_hx711.c)。

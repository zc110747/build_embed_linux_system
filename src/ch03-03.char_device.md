...
从上面可以看出，我们日常开发中大部分的设备都属于字符设备，网络设备和块设备虽然也多，但一般都使用系统自带的驱动，很少单独开发；其中网络设备主要包含以太网，CAN，wifi，蓝牙等，块设备则通常则是sd卡，Nand FLASH，emmc，固态和机械硬盘等等。
...
2. 控制引脚输出高或者低电平
3. 实现接口，用于应用中操作此I/O电平

对于嵌入式Linux系统，当然也可以直接配置寄存器实现功能和引脚控制，不过寄存器的配置有以下缺点:

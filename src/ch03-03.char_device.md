...
从上面可以看出，我们日常开发中大部分的设备都属于字符设备，反而网络设备和块设备反而更少，像网络设备一般有TCP网络，CAN网络，WIFI网络，块设备通常则是硬盘等。关于字符设备驱动的开发，本节则从以下几个方面讲解说明。
...
pinctrl_gpio_beep即是用于定义引脚配置信息的接口，会与iomuxc控制的I/O域中，而usr_beep即是在设备树中的实例，其中pinctrl-0用于将引脚配置和设备关联起来，beep-gpios控制引脚的状态管理，这里GPIO_ACTIVE_LOW控制引脚电平是否翻转。
...
不过字符型设备相关的知识不止于此，如SPI系统框架，I2C系统框架，input子系统等都属于字符设备的开发中涉及的技术，这些在后续章节后进一步说明。

本节代码可参考[字符设备代码](../src/file/ch03-03/).

## next_chapter

[返回目录](./SUMMARY.md)

直接开始下一节说明: [中断向量和中断管理](./ch03-04.interrput_interaction.md)

...
本节代码可参考:[字符设备代码](../src/file/ch03-03.char_device/kernel_miscbeep.c).
...
此即字符设备实现的常规步骤，无论简单的gpio，pwm内部模块，复杂的触摸屏，rtc，nvmem，i2c/spi外部器件，其基础框架都是类似的，只是具体的操作接口和硬件资源不同，具体模板可参考:[字符设备代码模板](../src/file/ch03-03.char_device/kernel_example.c).

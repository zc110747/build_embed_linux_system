...
sudo apt-get install libpixman-1-dev libgtk-3-dev libsdl2-dev

# 环境检测，生成Makefile
./configure --prefix=$PWD/ --target-list="arm-softmmu arm-linux-user" --enable-debug --enable-sdl --enable-kvm --enable-gtk --enable-tools --disable-curl --disable-coreaudio --disable-pa --disable-sndio
make -j6

...
- [ch01.构建Linux开发平台环境](./src/ch01-00.platform_env_struct.md)
  ...
  - [ch01-x1.Linux平台常见问题总结](./src/ch01-x1.linux_feature.md)
...
- [ch02.Linux系统启动实现](./src/ch02-00.system_bringup.md)
  ...
  - [ch02-x6.嵌入式linux平台常见问题总结](./src/ch02-x6.system_feature.md)
...
- [ch03.Linux驱动开发](./src/ch03-00.driver_design.md)
  ...
  - [ch03-23.brightness管理框架](./src/ch03-23.brightness.md)
  ...
  - [ch03-x7.T113_i设备树分析](./src/ch03-x7.t113_i_dts_analysis.md)
  - [ch03-x8.RK3568设备树分析](./src/ch03-x8.rk3568_dts_analysis.md)
  - [ch03-x9.驱动问题分析和解决](./src/ch03-x9.driver_issue_fix.md)
...
- [ch04.Linux应用开发设计](./src/ch04-00.application_design.md)
  ...
  - [ch04-03.基于QT的界面开发](./src/ch04-03.gui_qt_design.md)
  - [ch04-04.基于LVGL的界面开发](./src/ch04-04.lvgl_application.md)
  - [ch04-05.Linux平台web应用开发](./src/ch04-05.web_design.md)
  - [ch04-06.Linux平台的socket网络实现](./src/ch04-06.socket_design.md)
  - [ch04-07.使用python进行应用开发](./src/ch04-07.python_design.md)
  - [ch04-08.综合应用开发](./src/ch04-08.integrated_design.md)

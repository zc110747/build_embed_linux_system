...
本系列整理一系列嵌入式Linux学习和开发中应用的技术。按照功能划分为SDK平台构建、嵌入式Linux运行平台构建、驱动开发技术和应用开发技术；包含了嵌入式Linux开发中的主要技术。

📑 *SDK平台构建*，包含Linux系统安装(Ubuntu、Arch Linux、centos等)、软件和支持库安装、交叉编译、shell语法，以及快速部署SDK方案的技术  
...
- [ch02.linux系统启动实现](./src/ch02-00.system_bringup.md)
  ...
  - [ch02-06.linux-kernel移植方法](./src/ch02-06.kernel_transplate.md)
  ...
  - [ch02-15.基于armbian构建系统平台](./src/ch02-15.rootfs_armbian.md)
  - [ch02-16.安卓sdk构建](./src/ch02-16.android_sdk.md)
  - [ch02-17.u-boot spl和TF-A机制](./src/ch02-17.spl_and_tfa.md)
  - [ch02-18.异构多核芯片功能应用](./src/ch02-18.multi_core.md)
  - [ch02-19.虚拟机和沙箱启动](./src/ch02-19.virtual_machine.md)
...
- [ch03.linux驱动开发](./src/ch03-00.driver_design.md)
  ...
  - [ch03-15.WDT设备管理框架](./src/ch03-15.wdt.md)
  - [ch03-16.random随机数模块](./src/ch03-16.random.md)
  - [ch03-17.regulator电源管理](./src/ch03-17.regulator.md)
  - [ch03-18.串口tty管理框架](./src/ch03-18.tty_serial_console.md)
  - [ch03-19.nvmem子系统管理框架](./src/ch03-19.nvmem.md)
  - [ch03-20.摄像头CSI接口管理驱动](./src/ch03-20.csi_frame.md)
  ...
  - [ch03-24.图形显示FrameBuffer和DRM管理框架](./src/ch03-24.fb_frame.md)
  - [ch03-25.音频audio codec输出模块](./src/ch03-25.audio.md)
  - [ch03-26.hdmi输出设备驱动说明](./src/ch03-26.hdmi_output.md)
  - [ch03-27.pcie设备接口驱动](./src/ch03-27.pcie.md)
  - [ch03-28.系统时钟和opp管理模块](./src/ch03-28.cpufreq_opp.md)
  - [ch03-29.系统模块时钟管理接口](./src/ch03-29.clk_subsystem.md)
  - [ch03-30.npu驱动应用说明](./src/ch03-30.npu_rknn.md)
  - [ch03-31.块设备驱动和RAM模拟实现](./src/ch03-31.block_virt_ram.md)
  - [ch03-32.块设备驱动和内核中SD卡驱动解析](./src/ch03-32.block_sd.md)
  ...
  - [ch03-x9.设备驱动中的并发控制](./src/ch03-x9.core_concurrency.md)
  - [ch03-xa.多核异构芯片驱动开发](./src/ch03-xa.amp_process.md)
...
- [ch04.linux应用开发设计](./src/ch04-00.application_design.md)
  ...
  - [ch04-02.使用gdb进行本地和远程调试](./src/ch04-02.linux_debug_gdb.md)
  - [ch04-03.时间time处理接口](./src/ch04-03.time_function.md)
  - [ch04-04.socket常用接口实现](./src/ch04-04.socket_design.md)
  - [ch04-05.进程间通讯方法](./src/ch04-05.process_communication.md)
  - [ch04-06.linux应用硬件访问方法](./src/ch04-06.hardware_access.md)
  - [ch04-07.基于C++实现web服务器操作硬件](./src/ch04-07.web_design.md)
  - [ch04-08.framebuffer应用实现](./src/ch04-08.fb_app.md)
  - [ch04-09.QT应用界面功能说明](./src/ch04-09.gui_qt_design.md)
  - [ch04-10.LVGL移植和图形应用开发](./src/ch04-10.lvgl_application.md)
...
本系列主要按照如何构建一个完整嵌入Linux产品应用的开发流程来说明，而不是以难易度进行先后顺序的整理。

⚠️  **注意：学习中遇到难题，可以跳过直接进行后续的学习；从简单的入手，熟悉基础知识后可能更高效。**

嵌入式Linux是用于产品开发的技术，只依靠文档学习是远远不够的；需要在实际硬件平台调试验证，理解源码，自己设计开发应用，才能够深入理解掌握。

可以看到本系列文章涉及内容广泛，限于篇幅部分技术只能浅尝辄止，在讲解相应章节时也会列出我在整理以及开发时涉及的书籍，可以同步去学习。
